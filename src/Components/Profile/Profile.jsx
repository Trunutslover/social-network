...
export default function Profile(props) {
    ...
    for (let key in props.userProfile.contacts) {
        contacts.push(<div className={classes.contact} key={key}><b>{key}: </b>{props.userProfile.contacts[key]}</div>)
    }
                ...
                : <div>
                    ...
                    <div>
                        ...
                        {editStatus
                            ...
                            :
                            <span
                                onClick={props.userProfile.userId === props.myId ? enableEditStatus : undefined}>{props.status || (props.userProfile.userId === props.myId ? `Click here to change status` : undefined)}</span>
                        }
                    </div>
                    <div>
                    ...
                    {props.userProfile.userId === props.myId && <button onClick={() => setEditProfile(true)}>Edit profile</button>}
                </div>
            }
        </div>
    )
