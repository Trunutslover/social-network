...
export const selectPage = (page) => {return {type: SELECT_PAGE, page}};
export const follow = (user) => {return {type: FOLLOW, user}};
export const unfollow = (user) => {return {type: UNFOLLOW, user}};
export const toggleFetching = (isFetching) => {return {type: TOGGLE_FETCHING, isFetching}};
export const toggleFollowing = (isFollowing, userId) => {return {type: TOGGLE_FOLLOWING, isFollowing, userId}};
